<!DOCTYPE html>
<!--
	 Log On To www.code-projects.org for more free projects.
-->
<html lang="en">
	<head>
		<meta charset="UTF-8">
	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				<h2>Welcome to BookMyBusTicket</h2>Brou
				<p>Quick Search <br> Online Bookings <br> Pay Online <br> Hassle Free Bus Booking<br>ght To You By code-projects.org</p>
				<ul class="actions">
					<li>
